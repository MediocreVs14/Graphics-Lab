...
// Question : Rotation around 30 deg , then translation of (3,2)
...
void init() {
	...
	glLoadIdentity();
	gluOrtho2D(-250.0, 250.0, -250.0, 250.0); // here (0,0) will be center of window
}
...
void display() {
	...
	// to draw a line
	float x1, y1, x2, y2;
	cout << "Enter the terminal coordinates of the line : ";
	cin >> x1 >> y1 >> x2 >> y2;
